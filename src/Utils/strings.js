export const APPOINTMENT_BOOKED_SUCCESS = "Appointment booked successfully!";
export const BOOKING_SLOT_ALREADY_BOOKED =
...
export const NO_DOCTORS_FOUND = "No doctors found.";
...
export const PLEASE_SELECT_DOCTOR = "Please select a doctor.";
export const REQUIRED_FIELDS = "Please fill all required fields.";
export const ROOM_BOOKING_SLOT_ALREADY_BOOKED =
  "This time slot is already booked. Please select another.";
...
export const DOCTOR_REQUIRED = "Doctor required.";
export const ENTER_VALID_DATA = "Please fill all fields correctly.";
export const INVALID_OTP = "Invalid OTP.";
export const OTP_VERIFY_SUCCESS = "OTP verification successful!";
export const ENTER_CORRECT_OTP = "Please enter all 6 digits of the OTP.";
export const RESEND_OTP = "OTP Resent";
